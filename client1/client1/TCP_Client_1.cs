...
namespace client1
{
    public partial class TCP_Client_1 : Form
    {
        ...
        string[] clients_f = new string[2];
        int tedad = 0;
        IPEndPoint ipservers;
        string[,] ss = new string[10, 3];
        byte[] barray_2 = new byte[1024];
        int ersal = 0;
        ...
        public TCP_Client_1()
        {
            ...
            IPEndPoint ipens = new IPEndPoint(IPAddress.Parse("127.0.0.5"), int.Parse("4040"));
            socketClint.Bind(ipens);
            IPEndPoint ipensr = new IPEndPoint(IPAddress.Parse("127.0.0.5"), int.Parse("4041"));
       ...
       private void bt_con_Click(object sender, EventArgs e)
        ...
        private void bt_send_Click(object sender, EventArgs e)
        {
            ...
            if (sen.Checked)
            {
                ...
                barray =Encoding.Unicode.GetBytes(Path.GetFileNameWithoutExtension(fs.Name)+ ","+"1"+","+"127.0.0.5"+","+"4041");
...
//End Browse File
        ...
        private void sen_CheckedChanged(object sender, EventArgs e)
        {
