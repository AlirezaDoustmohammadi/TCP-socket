...
namespace client1
{
    public partial class TCP_Client_2 : Form
    {
        ...
        public TCP_Client_2()
        {
            ...
            IPEndPoint ipens = new IPEndPoint(IPAddress.Parse("127.0.0.5"), int.Parse("4042"));
            socketClint.Bind(ipens);
            IPEndPoint ipensr = new IPEndPoint(IPAddress.Parse("127.0.0.5"), int.Parse("4043"));
       ...
       private void bt_con_Click(object sender, EventArgs e)
        ...
        private void bt_send_Click(object sender, EventArgs e)
        {
            ...
            if (sen.Checked)
            {
                ...
                barray = Encoding.Unicode.GetBytes(Path.GetFileNameWithoutExtension(fs.Name) + "," + "1" + "," + "127.0.0.5" + "," + "4043");
